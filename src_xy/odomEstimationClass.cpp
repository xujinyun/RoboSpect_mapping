...
void OdomEstimationClass::updateStateToMap(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr& edge_in, const pcl::PointCloud<pcl::PointXYZRGB>::Ptr& surf_in, const Eigen::Isometry3d odom_in){
    ...
    // printf("cornor map count before: %d", (int)laserCloudCornerMap->points.size());
    // printf("surf map count before: %d", (int)laserCloudSurfMap->points.size());
    ...
    // printf("cornor map count after: %d", (int)laserCloudCornerMap->points.size());
    // printf("surf map count after: %d", (int)laserCloudSurfMap->points.size());
